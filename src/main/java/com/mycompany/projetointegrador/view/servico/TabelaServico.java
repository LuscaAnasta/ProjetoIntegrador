...
public class TabelaServico extends AbstractTableModel{
    private final List<Object[]> data;
    private final String[] columnNames = {"ID", "Descriçao", "Valor", " ", "  "};
    ...
    public TabelaServico() {
        ...
        try {
            ...
            ArrayList<Servico> servicos = ler.lerServico();
            
            for (Servico servico : servicos) {
                data.add(new Object[]{servico.getId(),servico.getDescricao(), servico.getValor(), "Editar", "Deletar"});
            }
   ...
   public int getColumnCount() {
    ...
    public boolean isCellEditable(int rowIndex, int columnIndex) {
        return columnIndex >= 3; // Somente as colunas dos botões são editáveis
    }
