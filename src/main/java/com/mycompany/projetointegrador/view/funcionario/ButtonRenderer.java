    ...
    public Object getCellEditorValue() {
        if (isPushed) {
            ...
            if (columnName.equals(" ")) {
                ...
                TelaFuncionarioEditar telaEd = new TelaFuncionarioEditar(tela, Integer.parseInt(idValue.toString()));
                ...
                if(deletar == JOptionPane.YES_OPTION){
                    ...
                    FuncionarioDeletarController delete = new FuncionarioDeletarController();
                    delete.deletarFuncionario(new Funcionario(Integer.parseInt(idValue.toString())));
                }
            }
        }
        isPushed = false;
